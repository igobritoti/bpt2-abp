...
- Listing detail agora reforça a identidade canônica do veículo com geração/versão/Ano-modelo e campos técnicos opacos quando já existem no catálogo, mantendo o Vehicle Hub como autoridade canônica completa;
