...
- GitHub workflow files: **8** — `architecture-gate.yml`, `fresh-migration-gate.yml`, `gate01.yml`, `harness-gate.yml`, `host-gate.yml`, `listing-http-lifecycle-gate.yml`, `listing-photo-http-gate.yml`, `product-api-gate.yml`
