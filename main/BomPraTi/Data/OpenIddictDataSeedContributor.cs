...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _scopeManager.FindByNameAsync("BomPraTi") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor
            {
                Name = "BomPraTi",
                DisplayName = "BomPraTi API",
                Resources =
                {
                    "BomPraTi"
                }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["BomPraTi_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var webClientRootUrl = configurationSection["BomPraTi_App:RootUrl"]?.TrimEnd('/');
        ...
        {
            var swaggerRootUrl = configurationSection["BomPraTi_Swagger:RootUrl"]?.TrimEnd('/');
