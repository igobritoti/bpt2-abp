...
public class BuyerWebOpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    private readonly IConfiguration _configuration;
    private readonly IOpenIddictApplicationManager _applicationManager;

    public BuyerWebOpenIddictDataSeedContributor(
    ...
    {
        var section = _configuration.GetSection("OpenIddict:Applications:BomPraTi_BuyerWeb");
        ...
        var application = new OpenIddictApplicationDescriptor
        {
            ...
            DisplayName = "Bom Pra Ti Buyer Web"
        };

        application.RedirectUris.Add(new Uri($"{rootUrl}/favoritos/callback"));
        application.PostLogoutRedirectUris.Add(new Uri($"{rootUrl}/favoritos"));
